...
namespace WebAPI {
	...
	public class api : System.Web.Services.WebService {
        ...
        public void LogIn(string username, string password)
        {
            ...
            send("LogIn",serializeStyle.DATA_TABLE);
        }
        [WebMethod]
        public void getAllItem()
        {
            send("showAllItem", serializeStyle.DATA_TABLE);
        }
        [WebMethod]
        public void newUser(string username, string password,int BankAccountId, string SellerOrBuyer)
        {
            addParam("@username", username);
            addParam("@password", password);
            addParam("@BankAccountId", BankAccountId);
            addParam("@SellerOrBuyer", SellerOrBuyer);
            sqlExec("newUser");
        }
        [WebMethod]
        public void findItem(String Category)
        {
            addParam("@Category", Category);
            send("findItemByCategory", serializeStyle.DATA_TABLE);
        }
        [WebMethod]
        ...
        public void showCart(int UserId) {
            addParam("@UserId", UserId);
            send("showCart", serializeStyle.DATA_TABLE);
        }

        [WebMethod]
        public void checkOut(int UserId, string date)
        {
            addParam("@UserId", UserId);
        ...
        [WebMethod]
        public void showItem(int UserId)
        {
            addParam("@UserId", UserId);
            send("showItem", serializeStyle.DATA_TABLE);
        }

        [WebMethod]
        public void postItem(int UserId,string name,string des,string cat, double price)
        {
            addParam("@UserId", UserId);
            addParam("@Name", name);
            addParam("@Description", des);
            addParam("@Category", cat);
